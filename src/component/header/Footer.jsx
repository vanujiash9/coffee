    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
        ...
        <div className="sm:ml-0 ml-8">
          ...
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Giá cả</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Giới thiệu</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Liên hệ</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Đánh giá</p>
        </div>
        <div>
          <h2 className="text-base font-semibold leading-4">Hỗ trợ</h2>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Chính sách pháp lý</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Chính sách trạng thái</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Chính sách bảo mật</p>
          <p className="hover:text-gray-500 text-base leading-4 mt-6 cursor-pointer">Điều khoản dịch vụ</p>
        </div>
        <div className="mt-10 lg:block hidden">
          ...
          <div className="cursor-pointer flex items-center justify-between border mt-4">
            <input type="text" className="text-base leading-4 p-4 w-full focus:outline-none placeholder-gray-800 dark:placeholder-gray-200" placeholder="Nhập email của bạn" />
            <svg className="mr-4 fill-current hover:text-gray-500 dark:hover:text-gray-300" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Nội dung SVG ở đây */}
            </svg>
          </div>
        </div>
      ...
      <div className="mt-10 lg:hidden">
        ...
        <div className="flex items-center justify-between border mt-4">
          <input type="text" className="text-base leading-4 p-4 relative z-0 w-full focus:outline-none placeholder-gray-800 dark:placeholder-gray-200" placeholder="Nhập email của bạn" />
          <div className="cursor-pointer mr-4 relative z-40">
            <svg className="fill-current hover:text-gray-500 dark:hover:text-gray-300" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
