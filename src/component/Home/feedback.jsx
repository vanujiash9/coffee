        ...
        <div className="w-80 sm:w-auto flex flex-col justify-start items-start">
          <div>
            <p className="text-3xl xl:text-4xl font-semibold leading-9 text-gray-800">
              Khám phá không gian quán cà phê của chúng tôi
            </p>
          </div>
          <div className="mt-4 lg:w-4/5 xl:w-3/5">
            <p className="text-base leading-6 text-gray-600">
              Tại quán cà phê của chúng tôi, bạn sẽ được thưởng thức những ly cà
              phê tuyệt hảo trong một không gian ấm cúng và sang trọng. Hãy đến
              và trải nghiệm những phút giây thư giãn tuyệt vời.
            </p>
          </div>
