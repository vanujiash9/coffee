          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Khám phá hương vị cà phê tinh túy của chúng tôi với những sự
                  kết hợp hoàn hảo. Tận hưởng không gian ấm cúng và dịch vụ chu
                  đáo tại quán cà phê của chúng tôi.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">
                      Giống như việc viết mã, pha trà hoàn hảo cần có sự kiên
                      nhẫn, chính xác, và một chút đam mê để tạo ra sự kết hợp
                      hương vị thú vị.
                    </p>
                  </div>
                </div>
